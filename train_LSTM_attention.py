...
outputpath='/home/dzhang/wudan/machine_learning/LSTM/output/model_lstm_attention_96.pt'
input_size = 12
input_length = 96
output_length = 240
hidden_size = 64
...
mae_min_list=[]
for k in range(5):
    outputpath='/home/dzhang/wudan/machine_learning/LSTM/output/model_lstm_atten_{output_length}_{k}.pt'
